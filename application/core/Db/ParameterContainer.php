...
class ParameterContainer implements \Iterator, \ArrayAccess, \Countable
{
    ...
    public function offsetSet($name, $value, $errata = null)
    {
        ...
        if (is_int($name)) {
            ...
            throw new Exception('Keys must be string, integer or null');
        }
    ...
    public function offsetGetErrata($name)
    {
        ...
        if (!array_key_exists($name, $this->data)) {
            throw new Exception('Data does not exist for this name/position');
        }
    ...
    public function merge($parameters)
    {
        if (!is_array($parameters) && !$parameters instanceof ParameterContainer) {
            throw new Exception('$parameters must be an array or an instance of ParameterContainer');
        }
