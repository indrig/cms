...
namespace Core\Db\TableGateway\Feature;

use Core\Db\Driver\ResultInterface;
use Core\Db\Driver\StatementInterface;
use Core\Db\ResultSet\ResultSetInterface;
use Core\Db\Sql\Delete;
use Core\Db\Sql\Insert;
use Core\Db\Sql\Select;
use Core\Db\Sql\Update;
use Core\EventManager\EventManager;
use Core\EventManager\EventManagerInterface;
use Core\EventManager\EventsCapableInterface;
