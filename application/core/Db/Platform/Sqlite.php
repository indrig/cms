...
class Sqlite implements PlatformInterface
{
    ...
    /**
     * @param \Core\Db\Driver\Pdo\Driver||\PDO $driver
     * @throws Exception
     * @return $this
     */
    public function setDriver($driver)
    {
        if (($driver instanceof \PDO && $driver->getAttribute(\PDO::ATTR_DRIVER_NAME) == 'sqlite')
            || ($driver instanceof Pdo\Driver && $driver->getDatabasePlatformName() == 'Sqlite')
        ) {
            $this->resource = $driver;
            return $this;
        }

        throw new Exception('$driver must be a Sqlite PDO Zend\Db\Adapter\Driver, Sqlite PDO instance');
    }
