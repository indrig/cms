...
namespace Core\Db\Driver\Pgsql;
...
class Connection implements ConnectionInterface, Profiler\ProfilerAwareInterface
{
    ...
    public function connect()
    {
        ...
        set_error_handler(function ($number, $string) {
            throw new Exception(
                __METHOD__ . ': Unable to connect to database', null, new Exception($string, $number)
            );
        });
     ...
     * @param  string $sql
     * @throws Exception
     * @return resource|\Core\Db\ResultSet\ResultSetInterface
     */
