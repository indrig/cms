...
abstract class AbstractTableGateway implements TableGatewayInterface
{
    ...
    protected function executeInsert(Insert $insert)
    {
        ...
        if ($insertState['table'] != $this->table) {
            throw new Exception('The table name of the provided Insert object must match that of the table');
        }
    ...
    /**
     * @param \Core\Db\Sql\Update $update
     * @return mixed
     */
    ...
    protected function executeUpdate(Update $update)
    {
        ...
        if ($updateState['table'] != $this->table) {
            throw new Exception('The table name of the provided Update object must match that of the table');
        }
    ...
    public function __get($property)
    {
        ...
        throw new Exception('Invalid magic property access in ' . __CLASS__ . '::__get()');
    }
    ...
    public function __set($property, $value)
    {
        ...
        throw new Exception('Invalid magic property access in ' . __CLASS__ . '::__set()');
    }
    ...
    public function __call($method, $arguments)
    {
        ...
        throw new Exception('Invalid method (' . $method . ') called, caught by ' . __CLASS__ . '::__call()');
    }
