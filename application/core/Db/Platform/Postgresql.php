...
class Postgresql implements PlatformInterface
{
    ...
    /**
     * @param \Core\Db\Driver\Pgsql\Driver|\Core\Db\Driver\Pdo\Driver|resource|\PDO $driver
     * @throws Exception
     * @return $this
     */
    public function setDriver($driver)
    {
        if ($driver instanceof Pgsql\Driver
            || ($driver instanceof Pdo\Driver && $driver->getDatabasePlatformName() == 'Postgresql')
        ...
        throw new Exception('$driver must be a Pgsql or Postgresql PDO Zend\Db\Adapter\Driver, pgsql link resource or Postgresql PDO instance');
    }
