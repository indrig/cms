...
use Engine\Table\Element\AbstractElement,
    Engine\Table\Element\Header,
    Engine\Table\Element\Row,
    Engine\Table\Element\Cell,
    Engine\Table\Adapter\AdapterInterface,
    Zend\Http\Request,
    Zend\Http\Response;
...
class Table extends AbstractElement
{
    ...
    /**
     * @var \Engine\Table\Adapter\AdapterInterface
     */
