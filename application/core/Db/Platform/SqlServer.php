...
class SqlServer implements PlatformInterface
{
    ...
    public function setDriver($driver)
    {
        ...
        if (($driver instanceof Pdo\Driver && in_array($driver->getDatabasePlatformName(), array('Sqlsrv', 'Dblib')))
        ...
        throw new Exception('$driver must be a Sqlsrv PDO Zend\Db\Adapter\Driver or Sqlsrv PDO instance');
    }
